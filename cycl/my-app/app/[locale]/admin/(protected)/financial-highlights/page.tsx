...
import FinancialHighlightsManagement from "@/components/admin/FinancialHighlightsManagement";
import { ChevronRight } from "lucide-react";

export default function FinancialHighlightsAdminPage() {
  return (
    <div className="min-h-screen bg-[#F0F2F5] text-[#334155] font-sans pb-20">
      <header className="sticky top-0 z-10 bg-white border-b border-slate-200 px-8 py-3 flex items-center justify-between">
        ...
        <span className="text-[10px] font-mono text-slate-400">/financial-highlights</span>
      </header>
      <main className="max-w-5xl mx-auto mt-8 px-6 space-y-8">
        <PageHeroCard pageKey="financial-highlights" />
